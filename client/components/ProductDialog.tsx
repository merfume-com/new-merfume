...
// // Important Note Component - Only shown for standard category products
// const ImportantNote = ({ category }: { category: string }) => {
//   // Only show for standard category
//   if (category.toLowerCase() !== 'standard') return null;
  
//   return (
//     <section className="py-4 bg-gradient-to-r from-amber-50/50 to-amber-100/30 dark:from-amber-950/20 dark:to-amber-900/10 border-y border-amber-200/30 dark:border-amber-800/30 rounded-xl mb-4">
//       <div className="px-4">
//         <div className="flex items-start gap-3 p-3 bg-white/50 dark:bg-black/20 backdrop-blur-sm rounded-lg border border-amber-200/50 dark:border-amber-800/50 shadow-sm">
...
//             // Product Content
//             <>
//               {/* Important Note - Only shown for standard category products */}
//               <ImportantNote category={product.productCategory} />
...
const ImportantNote = ({ category }: { category: string }) => {
  ...
  return (
    <div className="px-8 pt-4">
      <div className="bg-gradient-to-r from-amber-50/50 to-amber-100/30 dark:from-amber-950/20 dark:to-amber-900/10 border-y border-amber-200/30 dark:border-amber-800/30 rounded-xl mb-2">
        <div className="px-4 py-3">
          <div className="flex items-start gap-3 bg-white/50 dark:bg-black/20 backdrop-blur-sm rounded-lg border border-amber-200/50 dark:border-amber-800/50 shadow-sm p-3">
            <div className="flex-shrink-0">
              <div className="w-8 h-8 bg-amber-100 dark:bg-amber-900/30 rounded-full flex items-center justify-center">
                <Info className="h-4 w-4 text-amber-600 dark:text-amber-400" />
              </div>
