...
//                   Get notified about new products, exclusive offers, and updates from Merfume Store.
//                 </p>
...
export default function Home() {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <BadgePercent className="h-4 w-4 md:h-5 md:w-5 text-yellow-300" />
                </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="text-center">
            ...
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4">
              Discover Your
              <span className="block text-gold bg-gradient-to-r from-gold-dark to-gold bg-clip-text text-transparent pb-2">
                Signature Scent
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link to="/store">
                <Button
                  size="lg"
                  className="bg-gold hover:bg-gold-dark text-luxury-black font-semibold px-6 py-3 text-base group"
                >
                  Explore Collection
              ...
              <Link to="/about">
                <Button
                  variant="outline"
                  size="lg"
                  className="border-gold text-gold hover:bg-gold hover:text-luxury-black px-6 py-3 text-base"
                >
                  Our Story
                </Button>
              </Link>
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center mb-4">
            <div className="bg-yellow-400 p-3 rounded-full">
              <Moon className="h-8 w-8 text-emerald-900" />
            </div>
          </div>
  ...
  <Button 
    variant="outline" 
    className="border-2 border-white bg-white text-emerald-900 hover:bg-emerald-600 hover:text-white hover:border-emerald-600 px-6 py-3 text-base font-medium transition-all duration-300 shadow-md hover:shadow-lg"
  >
      ...
      <footer className="bg-luxury-black text-cream py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <h3 className="text-gold font-semibold mb-3 text-sm">Quick Links</h3>
