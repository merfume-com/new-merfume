...
//     // Prepare the inquiry data matching the backend DTO
//     const inquiryData = {
//       name: formData.name,
//       email: formData.email,
//       phone: formData.phone || "Not provided",
...
//        toast({
//         title: "Success",
//         description: "Your Inquiry Send Successfully",
//       });
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <Input
                          ...
                          placeholder="Enter your full name"
                          required
                          className="border-border focus:border-gold w-full"
                        />
                      </div>
                      <div>
                        <label
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={handleSelectChange}
                        >
                          <SelectTrigger className="border-border focus:border-gold w-full">
                            <SelectValue placeholder="Select inquiry type" />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value="product">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        rows={5}
                        required
                        className="border-border focus:border-gold resize-none w-full"
                      />
                    </div>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <Button
                      ...
                      className="border-gold text-gold hover:bg-gold hover:text-luxury-black"
                      onClick={() =>
                        window.open("https://wa.me/917489635061", "_blank")
                      }
                    >
                      WhatsApp
                    </Button>
                    <Button
                      ...
                      className="border-gold text-gold hover:bg-gold hover:text-luxury-black"
                      onClick={() =>
                        window.open("https://instagram.com/_merfume_", "_blank")
                      }
                    >
                      Instagram
                    </Button>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {faqs.map((faq, index) => (
                      <div
                        key={index}
                        className="border-b border-gold/20 pb-4 last:border-b-0"
                      >
                        <button
