...
function ProductSkeleton({ variant = "grid" }: { variant?: "grid" | "list" }) {
  if (variant === "grid") {
    return (
      <div className="group relative animate-pulse">
        <Card className="h-full border border-border/40 bg-gradient-to-b from-background to-background/95 overflow-hidden rounded-xl">
          {/* Image Skeleton */}
  ...
  return (
    <div className="group animate-pulse">
      <Card className="border border-border/40 bg-gradient-to-r from-background to-background/95 overflow-hidden rounded-xl">
